    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-md-12 esp" >
                <center>
                    <img src="../sistema/img/<?php echo $foto; ?>"  width="150" alt="" class="img-responsive img-thumbnail img-">
                    <br>
                    <h4><?php echo "$nome";?></h4>
                </center>
            </div>
            <div class="col-lg-12 col-md-12">
                ...
                <form method="POST" action="atualizadados.php" class="form-group" enctype="multipart/form-data">
                    <input type="text" name="matricula" value="<?php echo $_SESSION['ad_id']?>" style="display: none;"> 
                    <label>Nome:</label>
