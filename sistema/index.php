...
$sqlSomaDia = "SELECT DISTINCT ht_data  FROM pe_historico WHERE  ht_data  ";
$totaldias = 0;
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3 col-md-12 esp" >
                <center>
                    <img src="img/<?php echo $foto; ?>" width="150" alt="" class="img-responsive img-thumbnail">
                    <br>
                    <h4><?php echo "$nome";?></h4>
                    <?php echo "$cpf";?>  
                </center>
                  ...
                  <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 " >
                          <center>
                              Mês Anterior:
                              <br>
                              <h3> <a href="index.php?mesano=<?php echo $mess;?>"><i class="fa fa-chevron-left"></i> <?php echo  $mes[$mess]; ?></a></h3>
                          </center>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 " >
                          <center>
                ...
                <table class="table table-hover table-responsive">
                    ...
                    <tbody>
                      <form action="" method="get">
                       <?php
                            $sqlHistorico = "SELECT * FROM pe_historico WHERE ht_matricula = '$_SESSION[pin]' AND ht_data LIKE '%$mesano' ";
                            $numero = 1;
                ...
                <table class="table table-hover table-responsive">
                    ...
                    <tbody>
                       <?php
                            ...
                            $sqlHistoricoDetalhado = "SELECT * FROM pe_historico WHERE ht_matricula = '$_SESSION[pin]' ";
                            $numero = 1;
